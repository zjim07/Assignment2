...
public class Products extends SystemBar {
    ...
    private void switchToFrameByElement(WebElement iFrameQuickViewShoppingCart) {
    }
    ...
    public String getTrimmedElementText(WebElement modalShoppingCartSuccessOrFailMessage) {
    return getTrimmedElementText(modalShoppingCart);
    }
